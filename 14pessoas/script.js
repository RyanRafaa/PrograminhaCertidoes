...
btn.addEventListener("click", function(e) {
   ...
   /*14PESSOAS*/
   const name14 = document.querySelector("#name14");
   const cpf14 = document.querySelector("#cpf14");
       
       
   const cndt14 = document.querySelector("#cndt14")
   const cnat14 = document.querySelector("#cnat14")
   const rf14 = document.querySelector("#rf14")
   const re14 = document.querySelector("#re14")
   const regiao14 = document.querySelector("#regiao14")
   const regiaoc14 = document.querySelector("#regiaoc14")
       
   const cpfp14 = cpf14.value;
   const nomep14 = name14.value;
   const cndtn14 = cndt14.value
   const cnatn14 = cnat14.value
   const rfn14 = rf14.value
   const ren14 = re14.value
   const regiaon14 = regiao14.value
   const regiaocn14 = regiaoc14.value
    
  texto.innerHTML = ("b)- Certidão negativa de débitos trabalhistas - CNDT sob nº "+cndtn+" para o CPF nº "+cpfp+" em nome de "+nomep+", nº "+cndtn2+" para o CPF nº "+cpfp2+" em nome de "+nomep2+", nº "+cndtn3+" para o CPF nº "+cpfp3+" em nome de "+nomep3+", nº "+cndtn4+" para o CPF nº "+cpfp4+" em nome de "+nomep4+", nº "+cndtn5+" para o CPF nº "+cpfp5+" em nome de "+nomep5+", nº "+cndtn6+" para o CPF nº "+cpfp6+" em nome de "+nomep6+", nº "+cndtn7+" para o CPF nº "+cpfp7+" em nome de "+nomep7+", nº "+cndtn8+" para o CPF nº "+cpfp8+" em nome de "+nomep8+", nº "+cndtn9+" para o CPF nº "+cpfp9+" em nome de "+nomep9+", nº "+cndtn10+" para o CPF nº "+cpfp10+" em nome de "+nomep10+", nº "+cndtn11+" para o CPF nº "+cpfp11+" em nome de "+nomep11+", nº "+cndtn12+" para o CPF nº "+cpfp12+" em nome de "+nomep12+", nº "+cndtn13+" para o CPF nº "+cpfp13+" em nome de "+nomep13+" e nº "+cndtn14+" para o CPF nº "+cpfp14+" em nome de "+nomep14+", emitidas gratuitamente, via internet, pelo Poder Judiciário, Justiça do Trabalho, em "+ecndtn+", válidas até "+vcndtn+"; c)- Certidão negativa de ações trabalhistas do 1º Grau, do Tribunal Regional do Trabalho da 9ª Região, sob nº "+cnatn+" para o CPF nº "+cpfp+" em nome de "+nomep+", nº "+cnatn2+" para o CPF nº "+cpfp2+" em nome de "+nomep2+", nº "+cnatn3+" para o CPF nº "+cpfp3+" em nome de "+nomep3+", nº "+cnatn4+" para o CPF nº "+cpfp4+" em nome de "+nomep4+", nº "+cnatn5+" para o CPF nº "+cpfp5+" em nome de "+nomep5+", nº "+cnatn6+" para o CPF nº "+cpfp6+" em nome de "+nomep6+", nº "+cnatn7+" para o CPF nº "+cpfp7+" em nome de "+nomep7+", nº "+cnatn8+" para o CPF nº "+cpfp8+" em nome de "+nomep8+", nº "+cnatn9+" para o CPF nº "+cpfp9+" em nome de "+nomep9+", nº "+cnatn10+" para o CPF nº "+cpfp10+" em nome de "+nomep10+", nº "+cnatn11+" para o CPF nº "+cpfp11+" em nome de "+nomep11+", nº "+cnatn12+" para o CPF nº "+cpfp12+" em nome de "+nomep12+", nº "+cnatn13+" para o CPF nº "+cpfp13+" em nome de "+nomep13+" e nº "+cnatn14+" para o CPF nº "+cpfp14+" em nome de "+nomep14+", emitidas gratuitamente, via internet, pelo Poder Judiciário, Justiça do Trabalho, em "+ecnatn+", válidas por 30 dias; d)- Certidão negativa de débitos relativos aos tributos federais e à dívida ativa da União, com o código de controle "+rfn+" para o CPF nº "+cpfp+" em nome de "+nomep+", "+rfn2+" para o CPF nº "+cpfp2+" em nome de "+nomep2+", "+rfn3+" para o CPF nº "+cpfp3+" em nome de "+nomep3+", "+rfn4+" para o CPF nº "+cpfp4+" em nome de "+nomep4+", "+rfn5+" para o CPF nº "+cpfp5+" em nome de "+nomep5+", "+rfn6+" para o CPF nº "+cpfp6+" em nome de "+nomep6+", "+rfn7+" para o CPF nº "+cpfp7+" em nome de "+nomep7+", "+rfn8+" para o CPF nº "+cpfp8+" em nome de "+nomep8+", "+rfn9+" para o CPF nº "+cpfp9+" em nome de "+nomep9+", "+rfn10+" para o CPF nº "+cpfp10+" em nome de "+nomep10+", "+rfn11+" para o CPF nº "+cpfp11+" em nome de "+nomep11+", "+rfn12+" para o CPF nº "+cpfp12+" em nome de "+nomep12+", "+rfn13+" para o CPF nº "+cpfp13+" em nome de "+nomep13+" e "+rfn14+" para o CPF nº "+cpfp14+" em nome de "+nomep14+", emitidas gratuitamente, via internet, pelo Ministério da Fazenda, Secretaria da Receita Federal do Brasil, Procuradoria-Geral da Fazenda Nacional, em "+erfn+", válidas até "+vrfn+", a qual teve sua autenticidade confirmada e fica arquivada às folhas XXX, na Pasta de Arquivo de CND nº XXX, neste Tabelionato; e)- Certidão negativa de débitos tributários e de dívida ativa estadual, sob nº "+ren+" para o CPF nº "+cpfp+" em nome de "+nomep+", nº "+ren2+" para o CPF nº "+cpfp2+" em nome de "+nomep2+", nº "+ren3+" para o CPF nº "+cpfp3+" em nome de "+nomep3+", nº "+ren4+" para o CPF nº "+cpfp4+" em nome de "+nomep4+", nº "+ren5+" para o CPF nº "+cpfp5+" em nome de "+nomep5+", nº "+ren6+" para o CPF nº "+cpfp6+" em nome de "+nomep6+", nº "+ren7+" para o CPF nº "+cpfp7+" em nome de "+nomep7+", nº "+ren8+" para o CPF nº "+cpfp8+" em nome de "+nomep8+", nº "+ren9+" para o CPF nº "+cpfp9+" em nome de "+nomep9+", nº "+ren10+" para o CPF nº "+cpfp10+" em nome de "+nomep10+", nº "+ren11+" para o CPF nº "+cpfp11+" em nome de "+nomep11+", nº "+ren12+" para o CPF nº "+cpfp12+" em nome de "+nomep12+", nº "+ren13+" para o CPF nº "+cpfp13+" em nome de "+nomep13+" e nº "+ren14+" para o CPF nº "+cpfp14+" em nome de "+nomep14+", emitidas via internet, pela Secretaria de Estado da Fazenda, Receita Estadual do Paraná, em "+eren+", válidas até "+vren+"; f)- Certidões negativas de distribuição de ações e execuções cíveis e fiscais, e de execuções criminais da Justiça Federal da 4ª região, sob o nº "+regiaon+" e "+regiaocn+" para o CPF nº "+cpfp+" em nome de "+nomep+", nº "+regiaon2+" e "+regiaocn2+" para o CPF nº "+cpfp2+" em nome de "+nomep2+", nº "+regiaon3+" e "+regiaocn3+" para o CPF nº "+cpfp3+" em nome de "+nomep3+", nº "+regiaon4+" e "+regiaocn4+" para o CPF nº "+cpfp4+" em nome de "+nomep4+", nº "+regiaon5+" e "+regiaocn5+" para o CPF nº "+cpfp5+" em nome de "+nomep5+", nº "+regiaon6+" e "+regiaocn6+" para o CPF nº "+cpfp6+" em nome de "+nomep6+", nº "+regiaon7+" e "+regiaocn7+" para o CPF nº "+cpfp7+" em nome de "+nomep7+", nº "+regiaon8+" e "+regiaocn8+" para o CPF nº "+cpfp8+" em nome de "+nomep8+", nº "+regiaon9+" e "+regiaocn9+" para o CPF nº "+cpfp9+" em nome de "+nomep9+", nº "+regiaon10+" e "+regiaocn10+" para o CPF nº "+cpfp10+" em nome de "+nomep10+", nº "+regiaon11+" e "+regiaocn11+" para o CPF nº "+cpfp11+" em nome de "+nomep11+", nº "+regiaon12+" e "+regiaocn12+" para o CPF nº "+cpfp12+" em nome de "+nomep12+", nº "+regiaon13+" e "+regiaocn13+" para o CPF nº "+cpfp13+" em nome de "+nomep13+" e nº "+regiaon14+" e "+regiaocn14+" para o CPF nº "+cpfp14+" em nome de "+nomep14+", emitidas via internet, em "+eregiaon+";")
